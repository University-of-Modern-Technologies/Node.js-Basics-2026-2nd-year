 ...
 *           type: string
 *           nullable: true
 *           example: https://res.cloudinary.com/demo/image/upload/v1234567890/avatars/user_1.jpg
 *     AuthTokensResponse:
 *       type: object
 *       properties:
 *         accessToken:
 ...
 *       422:
 *         description: Unsupported avatar file type
 */
router.patch('/avatar', authenticate, uploadAvatar.single('avatar'), updateAvatar)
